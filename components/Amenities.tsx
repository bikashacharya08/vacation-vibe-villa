...
export default function Amenities() {
  return (
    <section id="amenities" className="py-24 md:py-36 lg:py-48 px-6 bg-white overflow-hidden relative">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row gap-10 md:gap-24 mb-16 md:mb-24">
          ...
          <div className="md:w-3/5 flex flex-col justify-center">
            <Reveal delay={200}>
              <p className="text-stone text-base md:text-lg lg:text-xl font-light leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 md:gap-y-16">
          {amenities.map((item, index) => (
            <Reveal key={item.title} delay={index * 80}>
              <div className="group bg-cream p-6 md:p-8 border border-charcoal/5 hover:border-gold/30 hover:shadow-lg hover:-translate-y-1 transition-all duration-500 h-full">
                <div className="text-charcoal group-hover:text-gold mb-5 transition-colors duration-500">
                  {item.icon}
                </div>
